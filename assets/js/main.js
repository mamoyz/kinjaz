$(document).ready(function () {
  ...
  $(window).scroll(function (e) {
        ...
        if ($(window).scrollTop() + $(window).innerHeight() * 0.6 > $(this).offset().top) {
          $(this).addClass("init");
        }
        });
          ...
          if ($(window).scrollTop() + $(window).innerHeight() * 0.6 > $(this).offset().top) {
              setTimeout(() => {
                  ...
                  if (ww > 960) {
                      ...
                      $(this).css({
                              transform: "translate(0px," + parseFloat(($(window).scrollTop() + $(window).innerHeight() * 0.7 - $(this).offset().top) * 0.04).toFixed(2) + "px)"
                          });
                  }
                  // if (ww < 961 && ww > 767) {
